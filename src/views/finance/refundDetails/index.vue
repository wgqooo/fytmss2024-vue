...
<script setup lang="ts" name="ship-info">
  ...
  let columns = ref([
    ...
    { prop: 'tickDate', label: '订票时间' },
    { prop: 'stateDate', label: '退票时间' },
    { prop: 'tickNo', label: '票号' },
    { prop: 'passportNo', label: '护照' },
    { prop: 'trName', label: '姓名' },
    { prop: 'startDate', label: '出发时间' },
    { prop: 'returnDate', label: '返回时间' },
    { prop: 'tickCost', label: '订票金额' },
    { prop: 'serviceRate', label: '手续费率' },
    { prop: 'serviceCharge', label: '手续费' },
    { prop: 'refundAmount', label: '退款额' },
    { prop: 'travellerType', label: '旅客类型' },
    { prop: 'orderName', label: '售票方' },
    { prop: 'returnName', label: '退票方' },
    { prop: 'returnName', label: '退票方' },
  ])
  const page = reactive({
    index: 1,
