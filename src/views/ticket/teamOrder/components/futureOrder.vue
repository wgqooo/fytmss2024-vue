<template>
    ...
    <el-table :data="teamData" border :row-style="{ height: '60px' }" style="font-size: 1.2em">
      ...
      <el-table-column align="center" label="操作">
        <template #default="scope">
          ...
          <el-button type="success" size="large" icon="Plus" @click="addMember(scope.row)"> 添加团成员 </el-button>
        </template>
      </el-table-column>
    </el-table>
  ...
  <TeamDrawer ref="teamDrawer"></TeamDrawer>
</template>
