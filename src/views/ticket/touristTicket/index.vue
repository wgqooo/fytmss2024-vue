<template>
  <div class="app-container m-ticket">
    <div class="m-ticket-table">
      ...
      <div class="footer" v-if="active === 0"><VoyageInfo :handleEdit="handleEdit"/></div>
      <ChooseTravellers v-if="active === 1" :voyData="voyData" :orderData="orderData" :nextStep="nextStep"/>
