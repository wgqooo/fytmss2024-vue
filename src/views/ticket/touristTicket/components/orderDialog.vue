<template>
    <el-dialog v-model="dialogVisible" :title="title" width="30%" @close="close">
      <div style="display: flex;">
        ...
        <el-descriptions-item>
          ...
          {{ voyData[0]['startPort'] === 0 ? '抚远' : '哈巴洛夫斯克'}} ---> {{ voyData[0]['startPort'] === 0 ? '哈巴洛夫斯克' : '抚远'}}
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label>
            <div class="cell-item">
          ...
          {{ voyData[0]['voyDate'] }} / {{ voyData[0]['startTime'] }}
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label>
            <div class="cell-item">
          ...
          <el-tag size="small">{{ chooseTravellers.length }}</el-tag>
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label>
            <div class="cell-item">
      ...
      <el-table :data="chooseTravellers"
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" @click="generateOrder">确定</el-button>
        </span>
      </template>
    </el-dialog>
  </template>
  <script lang="ts" setup>
    ...
    const { chooseTravellers, voyData, getTotalMoney, generateOrder } = defineProps({
      chooseTravellers:{
        type: Array
      },
      voyData:{
